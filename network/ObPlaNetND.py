...
#         self.nd_trans16 = nn.Conv2d(512, 64, 1)
#         self.nd_trans8 = nn.Conv2d(256, 64, 1)
#         self.nd_selfdc_16 = simpleDFN(64, 64, 512, ks, 4)
#         self.nd_selfdc_8 = simpleDFN(64, 64, 512, ks, 4)

        self.nd_trans16 = nn.Conv2d(512, 512, 1)
        self.nd_trans8 = nn.Conv2d(256, 512, 1)


    def forward(self, bg_in_data, bg_nrm_data, bg_dpt_data, fg_in_data, mask_in_data=None, mode='test'):
        """
        Args:
        ...
        nd_in_data = torch.cat([bg_nrm_data, bg_dpt_data], dim=1)
        nd_in_data_1 = self.nd_encoder1(nd_in_data) 
        ...
        nd_in_data_2 = self.nd_encoder2(nd_in_data_1)  
        ...
        nd_in_data_4 = self.nd_encoder4(nd_in_data_2)  
        del fg_in_data_1, fg_in_data_2, nd_in_data_1, nd_in_data_2
        ...
        nd_in_data_8 = self.nd_encoder8(nd_in_data_4)
        ...
        nd_in_data_16 = self.nd_encoder16(nd_in_data_8)
        fg_in_data_32 = self.fg_encoder32(fg_in_data_16)  # torch.Size([2, 512, 8, 8])
        nd_in_data_32 = self.nd_encoder32(nd_in_data_16)
        ...
        in_data_8_aux_nd = self.nd_trans8(nd_in_data_16)  # torch.Size([2, 64, 16, 16])
        in_data_16_aux_nd = self.nd_trans16(nd_in_data_32)  # torch.Size([2, 64, 8, 8])
...
#         print(in_data_8_aux_nd.shape, in_data_16_aux_nd.shape, self.selfdc_16(bg_out_data_1, in_data_8_aux).shape, self.selfdc_8(bg_out_data, in_data_16_aux).shape)
        fuse_out = self.upsample_add(in_data_8_aux_nd, \
                                     in_data_16_aux_nd, \
                                     self.selfdc_16(bg_out_data_1, in_data_8_aux), \
...
#                                      self.selfdc_8(bg_out_data, in_data_16_aux), \
#                                      self.nd_selfdc_16(bg_out_data_1, in_data_8_aux_nd), \
#                                      self.nd_selfdc_8(bg_out_data, in_data_16_aux_nd))  # torch.Size([2, 64, 256, 256])
